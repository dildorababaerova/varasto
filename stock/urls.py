...
urlpatterns = [
    ...
    path('register/warehouse-staff/', views.register_warehouse_staff, name='register_warehouse_staff'),
    path('accounts/password_reset/', auth_views.PasswordResetView.as_view(), name='password_reset'),
    path('accounts/password_reset/done/', auth_views.PasswordResetDoneView.as_view(), name='password_reset_done'),
    path('accounts/reset/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(), name='password_reset_confirm'),
    path('accounts/reset/done/', auth_views.PasswordResetCompleteView.as_view(), name='password_reset_complete'),
    path('edit_item/<int:item_id>/<int:warehouseItem_id>/', views.add_item, name='edit_item'),
    path('manage_stock/', views.manage_stock, name='manage_stock'),
    path('add_item/', views.add_item, name='add_item'),
    path('delete_item/<int:item_id>/', views.delete_item, name='delete_item'),
    path('edit-quantity/<int:warehouse_item_id>/', views.edit_quantity_only, name='edit_quantity'),
